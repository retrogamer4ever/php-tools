<?php
    ...
    /*
        ...
        EmailAddressValidatorUtil Class
        ...
        Sample Code
        ----------------
        $validator = new EmailAddressValidatorUtil;
    ...
    */
    ...
    class EmailAddressValidatorUtil {
        ...
        protected static function check_local_portion($strLocalPortion) {
            ...
            if (!EmailAddressValidatorUtil::check_text_length($strLocalPortion, 1, 64)) {
                return false;
            }
